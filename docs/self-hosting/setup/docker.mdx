...
<Info>
  ...
  by editing `./formbricks/.env`, adding the taxonomy variables above, and restarting with
...
Please take a look at our [migration guide](/self-hosting/advanced/migration) for version specific steps to
update Formbricks.
